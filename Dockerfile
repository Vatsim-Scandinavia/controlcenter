...
FROM docker.io/library/node:24.9.0-alpine AS frontend
...
####################################################################################################
# Primary container
FROM docker.io/library/php:8.4.13-apache-bookworm
...
RUN install-php-extensions pdo_mysql pdo_pgsql opcache gd
