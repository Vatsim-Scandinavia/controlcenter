...
class FilesTest extends TestCase
{
    ...
    {
        $user = factory(\App\Models\User::class)->create(['group' => 3, 'id' => 10000001]);
    ...
    {
        $user = factory(\App\Models\User::class)->create(['group' => null, 'id' => 10000001]);
    ...
    public function regular_user_cant_delete_another_users_file()
    {
        ...
        $otherUser = factory(\App\Models\User::class)->create(['group' => null]);
