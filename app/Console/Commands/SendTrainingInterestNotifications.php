    ...
    public function handle()
    {
        ...
        foreach ($trainings as $training) {
            ...
            if($lastInterestRequest == null) {
                ...
                // Check if training in question is at least 30 days old
                ...
                if ($requestDeadline->diffInDays(now()) >= 14 && $requestConfirmed == null) {
                ...
                } elseif ($requestDeadline->diffInDays(now()) >= 7 && $requestConfirmed == null) {
                ...
                } elseif ($lastInterestRequest->created_at->diffInDays(now()) >= 30 && $training->created_at->diffInDays(now()) >= 30) {
