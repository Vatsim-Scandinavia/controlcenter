            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-sm table-borderless table-leftpadded table-striped" width="100%" cellspacing="0"
                            data-page-size="25" data-toggle="table" data-pagination="true" data-filter-control="true"
                                        ...
                                        <td class="text-nowrap">
                                            @if ($position->editable)
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#edit-position-modal-{{ $position->id }}">Edit</a>
