...
CREATE TABLE `area_rating` (
  ...
  `required_vatsim_rating` int(10) unsigned DEFAULT NULL,
  `allow_bundling` tinyint(1) DEFAULT NULL,
  `hour_requirement` int(11) DEFAULT NULL,
  `queue_length_low` int(10) unsigned DEFAULT NULL,
  `queue_length_high` int(10) unsigned DEFAULT NULL,
...
CREATE TABLE `areas` (
  ...
  `template_newreq` text DEFAULT NULL,
  `template_newmentor` text DEFAULT NULL,
  `template_pretraining` text DEFAULT NULL,
...
CREATE TABLE `bookings` (
  ...
  `vatsim_booking` int(11) DEFAULT NULL,
...
CREATE TABLE `feedback` (
  ...
  `reference_user_id` bigint(20) unsigned DEFAULT NULL,
  `reference_position_id` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE `positions` (
  ...
  `required_facility_rating_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ratings` (
  ...
  `vatsim_rating` int(10) unsigned DEFAULT NULL COMMENT 'NULL = Endorsement',
...
(23,'_lastCronRun','2025-11-03 20:10:34'),
(24,'feedbackEnable','1'),
...
CREATE TABLE `tasks` (
  ...
  `subject_training_id` bigint(20) unsigned NOT NULL,
  `subject_training_rating_id` int(10) unsigned DEFAULT NULL,
...
CREATE TABLE `training_activity` (
  ...
  `type` varchar(255) NOT NULL,
  `old_data` bigint(20) DEFAULT NULL,
  `new_data` bigint(20) DEFAULT NULL,
...
CREATE TABLE `training_examinations` (
  ...
  CONSTRAINT `training_examinations_position_id_foreign` FOREIGN KEY (`position_id`) REFERENCES `positions` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE `training_reports` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `training_id` bigint(20) unsigned NOT NULL,
  `written_by_id` bigint(20) unsigned DEFAULT NULL,
  `report_date` date NOT NULL,
  `content` text NOT NULL,
  `contentimprove` text DEFAULT NULL,
...
CREATE TABLE `trainings` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1=Standard, 2=Refresh, 3=Transfer, 4=Fast Track, 5=Familiarisation',
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '-4: Closed by system, -3: Closed on student’s request, -2: Closed on TA request, -1: Completed, 0: In queue, 1: Pre-training, 2: Active training, 3: Awaiting exam',
  `area_id` int(10) unsigned NOT NULL,
  ...
  `paused_length` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Dump completed on 2025-11-03 21:10:43
