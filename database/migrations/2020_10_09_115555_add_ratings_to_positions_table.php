...
class AddRatingsToPositionsTable extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasColumn('positions', 'rating'))
        {
            ...
            DB::table('positions')->where('callsign', 'EKCH_DEL')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'EKCH_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'EKCH_A_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'EFHK_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'EFHK_DEL')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'EFJY_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'EFRO_DEL')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'EFTP_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'BIKF_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'BIKF_2_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'BIKF_DEL')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'BIRK_APP')->update(['rating' => 4]);
            DB::table('positions')->where('callsign', 'BIRK_TWR')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'BIRK_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'BGTL_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENBO_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENBR_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENBR_DEL')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENDU_DEL')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENGM_W_DEL')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENGM_W_TWR')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENGM_W_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENGM_E_DEL')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENGM_E_TWR')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENGM_E_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ENGM_Q_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENRY_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENTO_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENVA_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ENZV_GND')->update(['rating' => 3]);
            ...
            // Sweden
            DB::table('positions')->where('callsign', 'ESCF_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESDF_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESGG_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ESGG_DEL')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESIB_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESMS_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESSA_N_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ESSA_W_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ESSA_E_GND')->update(['rating' => 3]);
            DB::table('positions')->where('callsign', 'ESSA_DEL')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESSB_GND')->update(['rating' => 3]);
            ...
            DB::table('positions')->where('callsign', 'ESTL_GND')->update(['rating' => 3]);
